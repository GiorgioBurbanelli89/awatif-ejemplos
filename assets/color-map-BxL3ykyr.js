import { g as D, x as h, v as d, A as k, f as b, h as C, C as R, j as L, k as T } from "./getReport-CMkXIj08.js";
import { g as N } from "./getParameters-B7wiSLGO.js";
...
Promise.all([
  ...
  function x(e) {
    var _a, _b, _c;
    const o = ((_a = e.nodes) == null ? void 0 : _a.val) || [], i = ((_b = e.elements) == null ? void 0 : _b.val) || [], t = ((_c = e.distances) == null ? void 0 : _c.val) || [], u = D(), m = t.length > 0 ? Math.min(...t) : 0, s = t.length > 0 ? Math.max(...t) : 0, M = t.length > 0 ? t.reduce((p, l) => p + l, 0) / t.length : 0, $ = t.indexOf(m), z = t.indexOf(s);
    return h`
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 900px; margin: 0 auto; padding: 20px;">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px; margin: 20px 0;">
        ...
        <div style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); color: white; padding: 20px; border-radius: 8px; text-align: center;">
          ...
          <p style="margin: 0; font-size: 11px; opacity: 0.8;">Node ${z}</p>
        </div>
      </div>
