import { C as v, v as _, D as m, x as y } from "./styles-pdtxawzU.js";
/**
* @license
...
* SPDX-License-Identifier: BSD-3-Clause
*/
const C = { CHILD: 2 }, Y = (t) => (...e) => ({ _$litDirective$: t, values: e });
class w {
  constructor(e) {
  }
  get _$AU() {
...
const H = (t) => {
  t.type == C.CHILD && (t._$AP ?? (t._$AP = b), t._$AQ ?? (t._$AQ = z));
};
class M extends w {
  constructor() {
...
const d = /* @__PURE__ */ new WeakMap(), E = Y(class extends M {
  render(t) {
    return v;
  }
  update(t, [e]) {
