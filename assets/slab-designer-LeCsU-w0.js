import { w as J, x as N, v as t, f as Z, h as q, l as Q, i as W, k as Y, j as tt } from "./getReport-CnIkx0ml.js";
import { g as et } from "./getParameters-Ce3duQQe.js";
import { g as at } from "./getTables-gQyJqEo2.js";
import { a as st } from "./analyze-CmnHHflB.js";
import { d as lt, __tla as __tla_0 } from "./deformCpp-CS-wCYO-.js";
import { g as ot, a as nt, b as it, c as A, d as H, __tla as __tla_1 } from "./getSolids-zhnAqBAR.js";
...
`, document.head.appendChild(n), a;
  ...
  function mt(a, s, n, l, u, C) {
    ...
    const B = M.map((i) => Number((u * 1e6 * i / k).toFixed(2))), O = Math.max(...B), F = a.f_mk * C, _ = B.map((i) => Number((i / F).toFixed(2))), j = Math.max(..._);
    return {
      slabHeight: b,
      thicknesses: o,
      zCordsFromMid: M,
