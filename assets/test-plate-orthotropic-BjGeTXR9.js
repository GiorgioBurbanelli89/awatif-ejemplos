import { x as Y, v as r, f as N, h as B, l as X, i as j, j as K, k as U } from "./getReport-CnIkx0ml.js";
import { a as Z } from "./analyze-CmnHHflB.js";
import { d as H, __tla as __tla_0 } from "./deformCpp-CS-wCYO-.js";
import { g as W } from "./getParameters-Ce3duQQe.js";
import { g as J, __tla as __tla_1 } from "./getMesh-DmUdekin.js";
import { o as Q } from "./unsafe-html-DSLeEmZR.js";
...
Promise.all([
  ...
  function _(t) {
    const e = t.validationData || {}, a = e.params || {}, i = e.orthoInfo || {}, d = a.a || 10, m = a.b || 10, u = a.t || 0.15, c = a.Ex || 1e10, v = a.Ey || 5e9, n = a.nu || 0.25, p = a.q || -1e3, y = a.meshDiv || 30, R = e.w_fem_mm || 0, f = e.w_reference || 16.903575, g = e.error || 0, E = e.numNodes || 0, x = e.numElements || 0, s = i.nuYX || n * v / c, C = 1 - n * s, k = i.Dx || c * Math.pow(u, 3) / (12 * C), w = i.Dy || v * Math.pow(u, 3) / (12 * C), D = i.Dxy || n * w, M = i.Gxy || 0.5 * c / (1 + n), O = c / v, P = g < 10, L = P ? "result-pass" : "result-fail", G = P ? "\u2713 PASS" : "\u2717 FAIL", q = [
      [
        k,
        D,
        0
    ...
    <div class="validation-report">
      ...
      <div class="theory-box">
        <strong>Ratio de Anisotrop\xEDa:</strong> Ex/Ey = ${o(O, 2)}<br>
        La placa es <strong class="highlight">${O}x m\xE1s r\xEDgida en X</strong> que en Y.
      </div>
      ...
      <div class="formula-box">
        ${b("Dx", "Ex\xB7t\xB3/[12\xB7(1-\u03BDxy\xB7\u03BDyx)]", o(k, 2))} N\xB7m<br><br>
      ...
      <div class="ortho-diagram">
        <svg viewBox="0 0 400 300">
          ...
          <text x="270" y="278" font-size="11">Ex/Ey = ${o(O, 1)}</text>
  ...
  r.derive(() => {
    ...
    }, l.deformOutputs.val = H(n, p, l.nodeInputs.val, l.elementInputs.val), l.analyzeOutputs.val = Z(n, p, l.elementInputs.val, l.deformOutputs.val);
    let f = 0;
