import { g as I, a as N, c as $, b as A, x as g, v as s, f as w, h as H, l as F, i as P, j as _, k as j } from "./getReport-CMkXIj08.js";
import { a as q } from "./analyze-CmnHHflB.js";
import { d as B, __tla as __tla_0 } from "./deformCpp-CS-wCYO-.js";
import { g as Y } from "./getParameters-B7wiSLGO.js";
...
Promise.all([
  ...
  const S = (a) => `<var>${a}</var>`, z = (a) => `<span class="eq">${a}</span>`, x = (a, r = 4) => a.toFixed(r);
  function M(a) {
    var _a, _b, _c, _d;
    const r = ((_a = a.nodes) == null ? void 0 : _a.val) || [], i = ((_b = a.elements) == null ? void 0 : _b.val) || [], n = (_c = a.deformOutputs) == null ? void 0 : _c.val, o = (_d = a.analyzeOutputs) == null ? void 0 : _d.val, e = I(), u = N();
    let p = 0, c = 0, h = "X";
    (n == null ? void 0 : n.deformations) && n.deformations.forEach((d, l) => {
      Math.abs(d[0]) > Math.abs(p) && (p = d[0], c = l, h = "X"), Math.abs(d[1]) > Math.abs(p) && (p = d[1], c = l, h = "Y"), Math.abs(d[2]) > Math.abs(p) && (p = d[2], c = l, h = "Z");
    });
    let y = 0, t = 0;
    return (o == null ? void 0 : o.normals) && o.normals.forEach((d, l) => {
      const m = Array.isArray(d) ? (d[0] + d[1]) / 2 : d;
    ...
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 900px; margin: 0 auto; padding: 20px;">
      ...
      ${(n == null ? void 0 : n.deformations) ? g`
        ...
        <table style="border-collapse: collapse; width: 100%;">
          ...
          ${Array.from(n.deformations.entries()).slice(0, 20).map(([d, l]) => g`
              <tr>
      ...
      ${(o == null ? void 0 : o.normals) ? g`
        ...
        <table style="border-collapse: collapse; width: 100%;">
          ...
          ${Array.from(o.normals.entries()).slice(0, 20).map(([d, l]) => {
  ...
  s.derive(() => {
    const a = b.dx.value.val, r = b.dy.value.val, i = b.dz.value.val, n = b.divisions.value.val;
    let o = [], e = [];
    ...
    const u = [
      ...
      elasticities: new Map(e.map((t, d) => [
        d,
        100
      ])),
      areas: new Map(e.map((t, d) => [
        d,
        10
      ]))
    }, h = B(o, e, p, c), y = q(o, e, c, h);
  ...
  s.derive(() => {
    ...
    if (f.val === "Print") {
      ...
      if (r) {
        const i = (a == null ? void 0 : a.innerHTML) || "";
        r.document.write(`
        <!DOCTYPE html>
        <html>
...
${((_a = w({
      ...
      e.href = o, e.download = "3d_structure_report.html", document.body.appendChild(e), e.click(), document.body.removeChild(e), URL.revokeObjectURL(o), f.val = "";
    }
  });
  document.body.append(Y(b), H({
    mesh: v,
    settingsObj: {
      deformedShape: true,
      gridSize: 15
