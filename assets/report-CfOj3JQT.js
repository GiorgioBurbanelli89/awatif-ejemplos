import { x as s, v as e, f as w, k as $, j as x, h as y } from "./getReport-CMkXIj08.js";
import { a as z } from "./analyze-CmnHHflB.js";
import { d as T, __tla as __tla_0 } from "./deformCpp-CS-wCYO-.js";
...
Promise.all([
  ...
  }, l = e.state([]), o = e.state([]), i = e.state({}), d = e.state({}), n = e.state({}), r = e.state({}), v = {
    nodes: l,
    elements: o,
    nodeInputs: i,
    elementInputs: d,
  ...
  e.derive(() => {
    ...
    }, n.val = T(l.val, o.val, i.val, d.val), r.val = z(l.val, o.val, d.val, n.val);
  });
  const h = e.state(""), m = e.state(void 0);
  e.derive(() => {
    h.val === "Report" && (m.val = w({
      template: F,
      data: v
    }));
  });
