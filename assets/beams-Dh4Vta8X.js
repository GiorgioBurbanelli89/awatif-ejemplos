import { e as E, f as k, h as m, x as c, i as A, v as r, g as C, j as B, b as D, d as F } from "./styles-pdtxawzU.js";
import { a as H } from "./analyze-CmnHHflB.js";
import { d as Y, __tla as __tla_0 } from "./deformCpp-CS-wCYO-.js";
import { g as _ } from "./getParameters-Dl3mTgVW.js";
import { g as z } from "./getDialog-SKblNfmB.js";
...
Promise.all([
  ...
  const I = (t) => `<var>${t}</var>`, N = (t) => `<span class="eq">${t}</span>`, i = (t, s = 4) => t.toFixed(s);
  function $(t) {
    var _a, _b, _c, _d;
    const s = ((_a = t.nodes) == null ? void 0 : _a.val) || [], p = ((_b = t.elements) == null ? void 0 : _b.val) || [], l = (_c = t.deformOutputs) == null ? void 0 : _c.val, e = (_d = t.analyzeOutputs) == null ? void 0 : _d.val, a = E(), L = k();
    let f = 0, T = 0;
  ...
  }, y = r.state([]), n = r.state([]), w = r.state({}), u = r.state({}), M = r.state({}), U = r.state({});
  r.derive(() => {
    const t = g.length.value.val, s = g.height.value.val, p = g.xLoad.value.val;
    y.val = [
      [
        0,
        0,
    ...
    }, M.val = Y(y.val, n.val, w.val, u.val), U.val = H(y.val, n.val, u.val, M.val);
  });
  const x = {
    nodes: y,
    elements: n,
